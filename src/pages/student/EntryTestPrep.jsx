...
const TESTS = [
    {
        ...
        authority: 'MDCAT Syllabus & Pattern',
        icon: Microscope,
        duration: 180,
        questions: 180,
        subjects: [
    ...
    },
    {
        ...
        authority: 'ECAT Syllabus & Pattern',
        icon: Ruler,
        duration: 100,
        questions: 100,
        subjects: [
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
                ...
                >
                    ...
                    <p className="text-slate-500 dark:text-slate-400 text-base max-w-xl">
                        AI-generated questions for exam practice. Select your exam to begin.
                    </p>
                </motion.div>
                ...
                <p className="text-center text-slate-400 dark:text-slate-600 text-xs font-medium">
                    Questions are dynamically generated by AI · Progress is auto-saved
                </p>
            </div>
