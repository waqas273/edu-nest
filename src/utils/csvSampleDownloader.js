...
export const downloadSampleCSV = (type) => {
    ...
    switch (type) {
        case 'programs':
            ...
            content = `Title,Degree Type,Duration,Total Semesters,Estimated Fee,Description,Scholarship Tags,Admission Policy Tags
BS Computer Science,BS,4 Years,8,450000,"Comprehensive undergraduate program covering Software Engineering, AI and Data Science.","need-based, merit-based","cs"
MS Data Science,MS,2 Years,4,350000,"Advanced post-graduate program covering machine learning and big data analytics.","merit-based","postgraduate"
BS Electrical Engineering,BS,4 Years,8,500000,"State of the art engineering curriculum focusing on robotics and IoT.","need-based","engineering"
BS Business Administration,BBA,4 Years,8,400000,"Modern business administration degree focusing on marketing and finance.","sports-based","business"`;
            break;
